...
class DDC2SMoisSTKB(Base):
    ...
    pointsAssiduite = Column(Float(), name="points_assiduite")
    pointsEvol = Column(Float(), name="points_evol")
    totalPoints = Column(Float(), name="total_points")
    evolutionM1 = Column(Float(), name="evolution_m_1")
    c2sMoins1 = Column(Float(), name="c2s_m_1")
